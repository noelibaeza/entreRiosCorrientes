...
map.getView().fit([-7444030.636966, -4226129.072234, -5312295.276408, -2915061.784754], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sistema de uso de la tierra y contexto en el Espinal de Entre Ríos y Corrientes</h2>';
        return titleElement;
    })(),
